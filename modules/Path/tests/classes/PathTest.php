...
class PathTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFactory( $map, $exceptionName = '' )
    {
        ...
        $path = Path::factory( $map );

        $this->assertInstanceOf( '\\Miao\\Path', $path );
    }
    ...
    public function providerTestGetTemplateDir()
    {
        ...
        $data[ ] = array( 'Miao_TestOffice_View_Article_Item', '/www/rbc/libs/miao/master/modules/TestOffice/templates/View' );
