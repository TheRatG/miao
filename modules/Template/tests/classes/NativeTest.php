...
class NativeTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstruct()
    {
        ...
        $debugMode = false;
        $log = null;
        $tmp = new \Miao\Template\Native( $templatesDir, $debugMode, $log );
        ...
        new \Miao\Template\Native( '', $debugMode, $log );
    }
    ...
    public function testFetch( $templateName, $expected, $exceptionName = '' )
    {
        ...
        $templatesDir = \Miao\App::getInstance()
            ->getPath()
            ->getTestSourcesDir( __METHOD__ );
        $native = new \Miao\Template\Native( $templatesDir, false );
    ...
    public function testSetValueOf( $name, $value )
    {
        ...
        $pn = new \Miao\Template\Native( $this->_templatesDir );
    ...
    {
        $pn = new \Miao\Template\Native( $this->_templatesDir, false );
