 ...
 * @version    $Id: Mail.php 20096 2010-01-06 02:05:09Z bkarwin $
 */
class Miao_Log_Writer_Mail extends Miao_Log_Writer_Abstract
{
	/**
	...
	/**
	 * Create a new instance of Miao_Log_Writer_Mail
	 * 
	 * @param  array|Zend_Config $config
	 * @return Miao_Log_Writer_Mail
	 * @throws Miao_Log_Exception
	 */
	static public function factory( $config )
	{
		throw new Miao_Log_Exception( 'Miao_Log_Writer_Mail does not currently implement a factory' );
	}
	...
	/**
	 * Gets instance of Miao_Log_Formatter_Instance used for formatting a
	 * message using Zend_Layout, if applicable.
	 *
	 * @return Miao_Log_Formatter_Interface|null The formatter, or null.
	 */
	 ...
	 * @throws Miao_Log_Exception
	 */
	public function setLayoutFormatter( Miao_Log_Formatter_Interface $formatter )
	{
		if ( !$this->_layout )
		{
			throw new Miao_Log_Exception( 'cannot set formatter for layout; ' . 'a Zend_Layout instance is not in use' );
		}
	...
	public function setSubjectPrependText( $subject )
	{
		...
		{
			throw new Miao_Log_Exception( 'subject already set on mail; ' . 'cannot set subject prepend text' );
		}
	...
	public function shutdown()
	{
		...
		if ( $this->_layout )
		{
			...
			{
				trigger_error( 
					"exception occurred when rendering layout; " . "unable to set html body for message; " . "message = {$e->getMessage()}; " . "code = {$e->getCode()}; " . "exception class = " . get_class( 
						$e ), E_USER_NOTICE );
			}
		}
		...
		{
			trigger_error( 
				"unable to send log entries via email; " . "message = {$e->getMessage()}; " . "code = {$e->getCode()}; " . "exception class = " . get_class( 
					$e ), E_USER_WARNING );
		}
	}
